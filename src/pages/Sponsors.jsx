      ...
      <div className="container-fluid py-5" style={{ marginTop: "100px" }}>
        <div className="container-fluid px-4 px-lg-5">
          <div className="terms-card">
            ...
            <div className="mb-5">
              <h5 className="mb-3">Title Sponsor</h5>
              <div className="row g-4">
                <div className="col-12 col-md-6 col-lg-4">
                  ...
                  >
                    <img
                      src="/sponser/image.png"
                      alt="HDFC Bank title sponsor logo"
            ...
            <div className="mb-5">
              <h5 className="mb-3">Media Sponsor</h5>
              <div className="row g-4">
                <div className="col-12 col-md-6 col-lg-4">
                  <div
                    style={{
                  ...
                  >
                    <img
                      ...
                      alt="Vaaimai Kural media sponsor logo"
                      style={{ width: "100%", height: "auto", display: "block" }}
                    />
                    <div style={{ padding: "14px 16px" }}>
                      <div style={{ fontWeight: 800, fontSize: "1rem", color: "#1f2937" }}>
            ...
            <div>
              <h5 className="mb-3">Event Sponsors (Others)</h5>
              <div className="row g-4">
                <div className="col-12 col-md-6 col-lg-4">
                  <div
                    style={{
